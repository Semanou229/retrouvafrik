...
export default function RetrouvAfrikLogo({ className = '', width = 40, height = 40, showText = false }: RetrouvAfrikLogoProps) {
  // Si showText est false, on affiche seulement la silhouette de l'Afrique
  if (!showText) {
    return (
  ...
  // Sinon, on essaie d'utiliser l'image du logo complet
  return (
    <div className={`flex items-center ${className}`}>
      <Image
        src="/logo-retrouvafrik.png"
