...
export default function RetrouvAfrikLogo({ 
  ...
  return (
    <div className={`flex items-center ${className}`}>
      ...
      >
        {/* Loupe blanche */}
        <circle cx="25" cy="25" r="18" stroke="white" strokeWidth="3" fill="none"/>
        <line x1="35" y1="35" x2="45" y2="45" stroke="white" strokeWidth="3" strokeLinecap="round"/>
        ...
        <text x="55" y="32" fontFamily="Arial, sans-serif" fontSize="20" fontWeight="bold" fill="#ff6b35">
          Retrouv
        </text>
        
        {/* Texte "Afrik" en blanc */}
        <text x="120" y="32" fontFamily="Arial, sans-serif" fontSize="20" fontWeight="bold" fill="white">
          Afrik
        </text>
      </svg>
    </div>
